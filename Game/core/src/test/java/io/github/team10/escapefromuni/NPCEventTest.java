...
/**
 * Tests for the NPCEvent class.
 * NPCEvent is tested with the NPCEventType.LONGBOI value.
 */
public class NPCEventTest extends HeadlessTestRunner {

    private NPCEvent event;
    ...
    public void setUp() {
        ...
        event = new NPCEvent(NPCEventType.LONGBOI, mockPlayer, mockGame, manager);
