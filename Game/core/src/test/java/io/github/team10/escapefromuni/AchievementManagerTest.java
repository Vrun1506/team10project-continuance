...
public class AchievementManagerTest extends HeadlessTestRunner {
    ...
    public void initialiseAchievements() {
        // checks that achievement manager has been set up
        // checks that 8 achievements have been made
        // checks that all achievements are present
        // checks that all achievements are initialised to false
    ...
    @Test
    public void eventsPartial() {
        // ensures that event achievements remain incomplete when not all events are interacted with
        manager.initAchievements();
    ...
    @Test
    public void eventsFull() {
        // ensures that event achievements are set to complete when all events interacted with
        manager.initAchievements();
