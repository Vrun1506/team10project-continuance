...
public class SettingsPage implements Screen {
    ...
    /**
     * Initialises a SettingsPage object.
     * @param game the current EscapeGame object.
     * @param previousScreen the previous screen the user was on.
     */
    ...
    /**
     * Updates the sound volume slider.
     */
     ...
     * @param level the new level the audio should be.
     */
